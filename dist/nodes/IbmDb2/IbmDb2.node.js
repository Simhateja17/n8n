                ...
                if (credentials.connectionType === 'odbc') {
                    ...
                    try {
                        ...
                        try {
                            ...
                            throw new Error('ODBC connection requires the ibm_db package to be installed. ' +
                        ...
                        const odbcOptions = credentials.odbcOptions || {};
                        ...
                        data = await new Promise((resolve, reject) => {
                            ...
                            ibmdb.open(connStr, (error, conn) => {
                                ...
                                conn.query(finalQuery, paramValues, (queryError, result) => {
                        ...
                        throw new Error(`ODBC connection error: ${error.message}`);
                    }
                }
                else {
                    ...
                    if (credentials.connectionType === 'rest') {
                        ...
                        const restOptions = credentials.restOptions || {};
                    ...
                    requestOptions = {
                        ...
                        ...(credentials.sslOptions && typeof credentials.sslOptions === 'object' && {
                            rejectUnauthorized: !credentials.sslOptions.ignoreSsl,
                            requestCert: true,
                            agent: false
                        })
                    };
...
Original error: ${restError.message}`);
                ...
                const executionData = this.helpers.returnJsonArray(processedData);
